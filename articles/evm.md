...
2.  **Actual Cost (AC):** The actual cost incurred for the work
...
Set the actual costs and current time period and calculate the AC to
date:
...
![](evm_files/figure-html/unnamed-chunk-9-1.png)
