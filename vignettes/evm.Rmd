...
cv <- cv(ev, ac)
cat("The project is above budget because the Cost Variance (CV) is", cv, "\n")
```
...
cpi <- cpi(ev, ac)
cat("The project is above budget because the Cost Performance Index (CPI) is", round(cpi, 2), "\n")
```
