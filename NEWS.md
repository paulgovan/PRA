...
* Enhanced the sigmoidal model with additional features and improved parameter recovery tests.
* Updated Bayesian methods with improved documentation and error handling.
* Added comprehensive test suite with platform-dependent compatibility fixes for CRAN.
* Improved error handling across all functions with robust validations for NA, NaN, and Inf values.
