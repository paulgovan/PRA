...
EVM integrates scope, schedule, and cost into these three core quantities [@fleming2010]. From them, all the other EVM metrics flow, with every performance index, every forecast, and every variance coming back to PV, EV, and AC.
