...
EVM integrates scope, schedule, and cost into three core quantities [@flemming2010]:
...
- **TCPI > 1.2** is generally unrealistic — flag it as a signal to revise the budget rather than chase an unachievable efficiency target.
