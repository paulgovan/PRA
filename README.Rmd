...
* **Fully local** — runs on your machine via [Ollama](https://ollama.com), no API keys or cloud services
* **Interactive Shiny app** — chat UI with `/commands`, data upload, inline plots, and model settings
* **Evaluation framework** — measure tool-calling accuracy with [vitals](https://vitals.tidyverse.org)
